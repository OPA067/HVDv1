...
class Model(nn.Module):
    ...
    def forward(self, text, text_mask, video, video_mask, idx=None, global_step=0):
        ...
        ###### Step-I: See all (s_feat & f_feat_h) ######
        ...
        ###### Step-II: See one (w_feat & p_feat_h) ######
        ...
        ###### Step-III: See all & one (s_feat & f_feat || w_feat & p_feat) ######
        ...
        total_loss = (loss_sf_h + loss_wp_h) * self.alpha + (loss_sf + loss_wp) + (loss_kl_sf + loss_kl_wp)
